...
app.post('/api/v1/ultimate-device-lookup', (req, res) => {
    try {
        ...
        // Prevent server crash on error and return 500 status
...
// Only listen on port if running locally (Not on Vercel production)
...
// Export the app context for Vercel Serverless Architecture
module.exports = app;
